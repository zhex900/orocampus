                ...
                <div class="form-section">
                    ...
                    <section>
                        <div class="row">
                            ...
                            <div class="col6 last colspacer-two">
                                <label for="areyouchristian" class="lbl-text spacer">Are you a Christian:<span id="required">*</span></label>
                    ...
                    <section>
                        <div class="row">
                            <div class="col6 first">
                                <label for="international_student" class="lbl-text spacer">International Student:<span id="required">*</span></label>
