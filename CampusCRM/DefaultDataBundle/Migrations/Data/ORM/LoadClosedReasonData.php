...
class LoadClosedReasonData extends AbstractFixture
{
    /**
    ...
    {
        $className = ExtendHelper::buildEnumValueClassName('closed_reason_source');
        ...
        $handle = fopen($dir . "closed_reason.csv", "r");
