...
namespace CampusCRM\EventTopicsBundle\Migrations\Schema\v0_2;
...
class ExtendEventTopicsEntity implements Migration, ExtendExtensionAwareInterface
{
    ...
    public function up(Schema $schema, QueryBag $queries)
    {
        ...
        $this->extendExtension->addManyToOneRelation(
            ...
            'oro_eventtopics', // owning side field name
            'orocrm_eventtopics', // inverse side table
