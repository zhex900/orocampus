...
class LoadEventCategoryData extends AbstractFixture
{
    /**
    ...
    {
        $className = ExtendHelper::buildEnumValueClassName('event_category_source');
        ...
        $handle = fopen($dir . "event_category.csv", "r");
