...
use CampusCRM\CampusCalendarBundle\Entity\Attendee;
...
class AjaxCalendarEventController extends Controller
{
    ...
    public function attendeesAutocompleteDataAction($id)
    {
        ...
        $attendeeRelationManager = $this->get('campus_calendar.attendee_relation_manager');
    ...
    {
        return $this->get('campus_calendar.attendee_manager');
    }
}
