...
class LoadContactStatusData extends AbstractFixture
{
    /**
    ...
    {
        $className = ExtendHelper::buildEnumValueClassName('contact_status_source');
        ...
        $handle = fopen($dir . "contact_status.csv", "r");
