...
class LoadFollowupSourceData extends AbstractFixture
{
    /**
    ...
    {
        $className = ExtendHelper::buildEnumValueClassName('followup_source');
        ...
        $handle = fopen($dir . "followup_source.csv", "r");
